      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <form action="" className='flex flex-col lg:flex-row'>
          ...
          <label htmlFor="" className='flex justify-center items-center mt-3 w-80 lg:w-56 xl:w-64 h-12 m-1 border-2 rounded-md border-slate-600'>
            ...
            <input type="text" className='h-9 bg-transparent outline-none w-72' placeholder='2 travelers, 1 room' />   
          </label>
          <button type='button' className='bg-blue-600 text-white mt-3 mb-11 m-1 w-80 lg:w-32 h-12 rounded-3xl hover:bg-blue-800 duration-700'>Search</button>
        </form>
     </div>
    </section>
  )
